...
class Limo_estop:  # class declaration
    def __init__(self):  # constructor method
        ...
        rospy.Subscriber("/limo/scan", LaserScan, self.laser_callback)  # subscribe to /scan topic in ROS, and call laser_callback method every time new data is received
